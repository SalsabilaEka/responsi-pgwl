...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-person-praying"></i> GIWIS </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>GIWIS menyediakan fitur Map yang menampilkan persebaran tempat ibadah di Kota Semarang. Pengguna
                        dapat menambahkan informasi tempat ibadah dengan Create Point. Fitur Dashboard menyediakan
                        ringkasan dari jumlah tempat ibadah. Data persebaran tempat ibadah dapat diunduh dalam bentuk CSV. Fitur-fitur ini dapat diakses apabila pengguna sudah Login akun.</p>
                    <p>Salsabila Eka Fadila (22/494469/SV/20836) PGWL A </p>
                </div>
